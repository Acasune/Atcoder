...
signed main(){
  ...
  int ans=abs(((arr[0])/2)*arr[1]*arr[2]-((arr[0]+1)/2)*arr[1]*arr[2]);
  ans=min(ans,abs(((arr[1])/2)*arr[2]*arr[0]-((arr[1]+1)/2)*arr[2]*arr[0]));
  ans=min(ans,abs(((arr[2])/2)*arr[1]*arr[0]-((arr[2]+1)/2)*arr[1]*arr[0]));
